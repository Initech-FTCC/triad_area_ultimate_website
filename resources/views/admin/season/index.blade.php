...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="{{URL::route('admin.season.index')}}">Home</a>
                </li>
                <li class="active">
                    <a href="#">Season</a>
                </li>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                {{ Form::open(array('url' => 'admin/season', 'class' => 'new-category-form')) }}
                    <div class="row m-b categories">
                        ...
                        <div class="col-sm-4 m-b input-wrap">
                            <input type="text" class="form-control " name="name[]"  autofocus maxlength="25">
                        </div>
                        @endif
