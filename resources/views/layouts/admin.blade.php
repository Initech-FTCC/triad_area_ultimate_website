		...
		<nav class="navbar-default navbar-static-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav metismenu" id="side-menu">
							...
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        		<span class="clear">
									<span class="block m-t-xs">
										<strong class="font-bold">{{ full_name(Auth::user()->player) }}</strong>
                         			</span>
					...
					<li class="{{active_class($controller, 'SeasonController')}}">
						<a href="{!! URL::route('admin.season.index') !!}"><i class="fa fa-th-large"></i>
							<span class="nav-label">Season</span></a>
					</li>
